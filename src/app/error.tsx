  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-background">
      <div className="w-full max-w-sm space-y-6 text-center">
        ...
        {/* {error.digest && (
          <p className="text-[11px] text-muted font-mono bg-surface2 px-3 py-1.5 rounded-xl inline-block">
            {error.digest}
          </p>
        )} */}
        ...
        <div className="flex items-center justify-center gap-3">
          ...
          <Link
            href="/"
            className="px-5 py-2.5 bg-surface2 border border-surface2 hover:border-lime-green/20 text-muted hover:text-foreground text-sm font-medium rounded-xl transition"
          >
            Go home
          </Link>
        </div>
