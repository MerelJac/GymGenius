  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-5 pointer-events-none">
        <div className="bg-surface border-dashed border-2 border-surface2 rounded-2xl w-full max-w-sm pointer-events-auto p-5 space-y-4 max-h-[80vh] overflow-y-auto">

          {/* Handle */}
          <div className="w-8 h-1 bg-surface2 rounded-full mx-auto" />
          ...
          {/* List */}
          {subs.length === 0 ? (
            <div className="bg-surface2 rounded-2xl px-4 py-5 text-center space-y-1">
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-4 py-3.5 rounded-2xl border transition-all active:scale-[0.98] disabled:opacity-50 ${
                      selecting === ex.id
                        ...
                        : "bg-surface2 border-surface2 text-foreground hover:border-lime-green/20"
                    }`}
                  >
          ...
          <button
            onClick={onClose}
            className="w-full py-3 rounded-2xl bg-surface2 text-muted font-medium text-sm hover:text-foreground transition-colors"
          >
            Cancel
          </button>
