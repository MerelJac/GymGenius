...
import ExerciseList from "@/app/(trainer)/exercises/ExerciseList";
import ClientExerciseList from "./ClientExerciseList";
  ...
  return (
    <div className="space-y-8">
      ...
      {exercises.length === 0 ? (
        ...
        <ClientExerciseList exercises={exercises} userId={userId} />
      )}
          ...
          {Array.from({ length: totalPages }).map((_, i) => {
            ...
            return (
              <Link
                key={p}
                href={{
                  pathname: `/client/${userId}/exercises/exercise-list`,
                  query: {
                    ...(query ? { q: query } : {}),
                    page: p,
                  },
